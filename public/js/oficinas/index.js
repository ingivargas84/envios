var oficinas_table = $('#oficinas-table').DataTable({
    "responsive": true,
    "processing": true,
    "info": true,
    "showNEntries": true,
     ...
     
    {
        ...
        "render": function(data, type, full, meta) {
            ...
            if(full.estado == 'Activo'){
                ...
                "<a href='"+urlActual+"/edit/"+full.id+"' class='edit-oficina' >" + 
                "<i class='fa fa-btn fa-edit' title='Editar Oficina'></i>" + 
                "</a>" + "</div>" + 
                "<div class='float-right col-lg-4'>" + 
                "<a href='#' class='remove-oficina' data-method='delete' data-id='"+full.id+"' data-target='#modalConfirmarAccion' data-toggle='modal'>" + 
                "<i class='fa fa-thumbs-down' title='Desactivar Oficina'></i>" + 
                "</a>" + "</div>";    
            }else{
                if(rol_user == 'Super-Administrador' || rol_user == 'Administrador'){
                    return "<div id='" + full.id + "' class='text-center'>" + 
                    "<div class='float-right col-lg-6'>" + 
                    "<a href='"+urlActual+"/"+full.id+"/activar' class='activar-oficina'"+ "data-method='post' data-id='"+full.id+"' >" + 
                    "<i class='fa fa-thumbs-up' title='Activar Oficina'></i>" + 
                    "</a>" + "</div>";
                }else{
